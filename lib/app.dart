        ...
        onGenerateRoute: (settings) {
          switch (settings.name) {
            ...
            case AppRoutes.reports:
              return _r(settings, const ReportsScreen());

            // ── Driver ─────────────────────────────────────────────────
            case AppRoutes.driverHome:
              return _r(settings, const DriverHomeScreen());
            case AppRoutes.route:
              return _r(settings, const DriverRouteScreen());
            case AppRoutes.driverHistory:
              return _r(settings, const DriverHistoryScreen());
            case AppRoutes.attendance:
              return _r(settings, const AttendanceScreen());
            case AppRoutes.vehicleLinking:
              return _r(settings, const VehicleLinkingScreen());
            case AppRoutes.driverNotif:
              return _r(settings, const NotificationsScreen());
            case AppRoutes.emergency:
              return _r(settings, const EmergencyScreen());
